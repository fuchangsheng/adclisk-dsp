...
AlipaySubmit.prototype.buildRequestParaToString = function(para_temp){
    ...
    var request_data = this.alipay_gateway_new + core_funcs.createLinkstringUrlencode(para);
...
//    sHtml = sHtml+ "<input type='submit' value='" + button_name + "'></form>";
  ...
  //  sHtml = sHtml + "<script>document.forms['alipaysubmit'].submit();</script>";
    sHtml = sHtml+ "<input type='submit' class='btn btn-primary btn-left' id='alipaySubmitBtn' onclick='alipaysubmitFn()' value='" + button_name + "'></form>";

    sHtml = sHtml + "<script> function alipaysubmitFn() {document.forms['alipaysubmit'].submit();}</script>";
    return sHtml; 
}
