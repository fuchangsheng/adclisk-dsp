 ...
 * @description dashboard basic information to test API and logic
...
//model
var plan_summary = require('../model/dashboard/dashboard_plan_summary.test').create();
var plan_view = require('../model/dashboard/dashboard_plan_view.test').create();
var plan_download = require('../model/dashboard/dashboard_plan_download.test').create();
var unit_summary = require('../model/dashboard/dashboard_unit_summary.test').create();
var unit_view = require('../model/dashboard/dashboard_unit_view.test').create();
var unit_download = require('../model/dashboard/dashboard_unit_download.test').create();
var idea_summary = require('../model/dashboard/dashboard_idea_summary.test').create();
var idea_view = require('../model/dashboard/dashboard_idea_view.test').create();
var idea_download = require('../model/dashboard/dashboard_idea_download.test').create();
var overview = require('../model/dashboard/dashboard_overview.test').create();
var overview_download = require('../model/dashboard/dashboard_overview_download.test').create();
var summary = require('../model/dashboard/dashboard_summary.test').create();
var top_plans = require('../model/dashboard/dashboard_top_plans.test').create();
var top_units = require('../model/dashboard/dashboard_top_units.test').create();
var top_ideas = require('../model/dashboard/dashboard_top_ideas.test').create();
...
var config = require('../functions/dashboard_func').config;

var msg;
msg = 'to test interfaces of dashboard modules.';
...
describe('dashboard module', function(){
    var id; 
    var param = {
        start_time : '2000-2-1 00:00:00',
        end_time : '2000-2-2 00:00:00',
        unit : '小时', 
        data_type : '展现,点击,点击率',
        view : [{
            date_time : '',
