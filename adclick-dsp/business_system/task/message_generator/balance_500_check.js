/*
 * @file  balance_500_check.js
 * @description balance 500 yuan check task API and logic
 ...
 */
'use strict';
var MODULENAME = 'balance_500_check.logic';
...
function balance500NotifyMessage(user_id, user_name) {
    return function(cb) {
        var param = {};
        var content = ADCONSTANTS.MESSAGESUBCATEGORIES.FINANCIALBALANCE500.name;
        content += '，账户名：' + user_name + '，请及时确认';

        param.user_id = user_id;
        param.categories = ADCONSTANTS.MESSAGECATEGORIES.FINANCIAL.code;
        param.subcategories = ADCONSTANTS.MESSAGESUBCATEGORIES.FINANCIALBALANCE500.code;
...
function processCheckCallback() {
    var msglog = ' to check balance 500 task';
    ...
    mAsync.waterfall([
        function(next) {
            ...
            sqlstr += ' where balance<' + 500 * 1000 * 100;
        ...
        function(user_rows, next) {
            ...
            sqlstr += ' and subcategories=' + ADCONSTANTS.MESSAGESUBCATEGORIES.FINANCIALBALANCE500.code;
        ...
        function(user_rows, next) {
            ...
            for(var i in user_rows) {
                ...
                list.push(balance500NotifyMessage(user_id, user_name));
            }
        ...
        function(user_rows, next) {
            ...
            for(var i in needCreateUserIds) {
                ...
                var value = {
                    ...
                    subcategories: ADCONSTANTS.MESSAGESUBCATEGORIES.FINANCIALBALANCE500.code,
