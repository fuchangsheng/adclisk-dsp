...
!function(){
    ...
    function initMsgList(sort,categories,notify_status,index,count){
        ...
        var categories = categories || "所有消息";
    ...
    function loadUl(list){
        for(var i=0;i<list.length;i++){
            ...
            oDivHead.append("<div class='col-sm-3 col-md-2'>"+item.categories+"</div><div class='col-sm-4 col-md-6'>"+item.title+"</div><div class='col-sm-4 col-md-2'>"+item.create_time+"</div>");
            oLi.append(oDivHead);
    ...
    function queryList(){
        $("#pHead li:lt(2)").each(function(){
            var $this = $(this);
            $this.click(function(){
                $("#pHead li:lt(2)").removeClass("active");
