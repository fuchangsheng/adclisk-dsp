/*
 * @file  faccount_invoice_request_process.js
 ...
 */
'use strict';
var MODULENAME = 'faccount_invoice_request_process.logic';
var URLPATH = '/v1/aduser/faccount/invoice/process';
...
function processRequest(param, fn){
    ...
    var logmsg = ' to process invoice request for user: ' + user_id;
    ...
    mAsync.series([
        ...
        function(next) {
            ...
            mInvoiceOpLogModel.lookup(query, function(err, rows){
                if (err) {
                    ...
                    if (invoice_status!=ADCONSTANTS.INVOICESTATUS.PROCCESSING.code) {
                        var msg = 'Invalid request to process the invoice in state:';
        ...
        function(next) {
            var update = {
                invoice_status: ADCONSTANTS.INVOICESTATUS.PROCCESSED.code,
                tax_info_ticket: param.tax_info_ticket,
            };
            var match = {
        ...
        if (err) {
            ...
            param.invoice_status = ADCONSTANTS.INVOICESTATUS.PROCCESSED.code;
