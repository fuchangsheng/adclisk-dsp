...
var adConstants = {
    ...
    ROLEPERMISSIONPATHNAME: './conf/role-permission.json',
    DEFAULTCOUNT: 200,
    ROLE: new CDataModel({
    ...
    ADOPTIONALTYPE: new CDataModel({
        CITY: {code: 0,name: '城市'},
        PROVINCE: {code: 1,name: '省份'},
        DEVICE: {code: 2,name: '设备'},
        ADSLOT: {code: 3,name: '广告位'},
        TIME_HOURLY: {code: 4,name: '时间'},
        HOURLY: {code: 5,name: '小时'},
        WEEK:{code: 6,name: '星期'},
        OS:{code: 7,name: '操作系统'},
        ADVIEW:{code: 8,name:'联网类型'},
    }),
    ADPLANOPTIONSTYPE: new CDataModel({
        WEEK: {code: 0,name: '星期'},
        HOUR: {code: 1,name: '小时'},
        PROVINCE: {code: 2,name: '省份'},
        CITY: {code: 3,name: '城市'},
        DEVICE: {code: 4,name: '设备型号'},
        OS: {code: 5,name: '操作系统'},
        ADVIEW: {code: 6,name: '联网类型'},
    }),
    SUMMARYDATA: new CDataModel({
        ...
        CLICK: {code: 4,name: '点击'},
        CTR: {code: 5,name: '点击率'},
        CPC: {code: 6,name: '单次点击花费'},
        CPM: {code: 7,name: '千次展现花费'},
        COST: {code: 8,name: '花费'},
        ACTIVE: {code: 9,name: '激活'},
        CPA: {code: 10,name: '单次激活花费'},
    }),
