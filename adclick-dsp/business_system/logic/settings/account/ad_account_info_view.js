 ...
 */
'use strict';
var MODULENAME = 'ad_account_info_view.logic';
var URLPATH = '/v3/settings/account/info/view';
...
function packageResponseData(data){
    ...
    var resData = {
        ...
        user_audit_message: data.user_audit_message,
        categories : mCategoriesMapper.formatCategories(data.categories),
        subcategories : mCategoriesMapper.formatSubCategories(data.subcategories),
