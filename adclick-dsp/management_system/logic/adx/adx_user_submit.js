/*
 * @file  adx_user_submit.js
 * @description adx users submit API and logic
 ...
 */
'use strict';
var MODULENAME = 'adx_user_submit.logic';
var URLPATH = '/v1/adx/user/submit';
...
function processRequest(param, fn){
    ...
    var msg = ' to process adx user upload request for :' +  param.id;
    ...
    mAsync.waterfall([
        ...
        function(data, next) {
            ...
            if (!adx) {
                ...
                adx.userSubmitRouter(query, function(err, res) {
                    if (err) {
                        next(err);
                    } else {
                        next(null, res);
