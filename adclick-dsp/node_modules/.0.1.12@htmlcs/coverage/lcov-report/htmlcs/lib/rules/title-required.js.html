...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (charsetMeta &amp;&amp; title.previousElementSibling !== charsetMeta) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (charsetMeta.nextSibling) {
                head.insertBefore(title, charsetMeta.nextSibling);
            }
            else {
<span class="cstat-no" title="statement not covered" >                head.appendChild(title);</span>
            }
        }
    }
&nbsp;
