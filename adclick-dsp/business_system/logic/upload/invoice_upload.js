 ...
 */
'use strict';
var MODULENAME = 'invoice_upload.logic';
var URLPATH = '/v1/upload/invoice';
...
//var mUploader = multer({ dest: 'uploads/' });
//common constants
...
function processRequest(param, fn){
    ...
    var logmsg = ' to upload invoice for user:' + user_id ;
