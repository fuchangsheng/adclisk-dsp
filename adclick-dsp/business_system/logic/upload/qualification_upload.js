 ...
 */
'use strict';
var MODULENAME = 'qualification_upload.logic';
var URLPATH = '/v3/settings/account/qualification';
...
function processRequest(param, fn){
    ...
    var logmsg = ' to upload qualification for user:' + user_id ;
