/*
 * @file  adx_idea_submit.js
 * @description adx ideas submit API and logic
 ...
 */
'use strict';
var MODULENAME = 'adx_idea_submit.logic';
var URLPATH = '/v1/adx/idea/submit';
...
function processRequest(param, fn) {
    ...
    var msg = ' to process adx idea upload request for :' +  param.id;
    ...
    mAsync.waterfall([
        ...
        function(data, next) {
            ...
            if (!adx) {
                ...
                var ideas = [];
                ideas.push(data.idea_id);
                var query = {
                    ideas: ideas,
                    adx_id: data.adx_id
                };
                adx.ideaSubmitRouter(query, function(err, res) {
                    if (err) {
                        next(err);
                    } else {
                        next(null, res);
