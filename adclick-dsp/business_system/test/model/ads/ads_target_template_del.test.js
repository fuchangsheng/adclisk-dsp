/*
 * @file  ads_target_template_del.test.js
 * @description add ads_target_template_del basic information API and logic
 ...
 */
'use strict';
var MODULENAME = 'ads_target_template_del.test';
var PATH = '/v1/ad/target/template/del';
