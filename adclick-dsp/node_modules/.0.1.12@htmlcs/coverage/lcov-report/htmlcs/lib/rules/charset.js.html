...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (charsetMeta !== head.firstElementChild) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (head.firstElementChild) {
                head.insertBefore(charsetMeta, head.firstChild);
            }
            else {
<span class="cstat-no" title="statement not covered" >                head.appendChild(charsetMeta);</span>
            }
        }
    }
&nbsp;
