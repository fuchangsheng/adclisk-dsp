...
CREATE TABLE `adclick_dsp_realtime` (
  ...
  `ad_bid_type` varchar(11) NOT NULL DEFAULT '0' COMMENT '广告主行业分类',
  `adx` varchar(11) NOT NULL DEFAULT '0' COMMENT '广告主行业分类',
  `creative_type` varchar(11) NOT NULL DEFAULT '0' COMMENT '广告主行业分类',
  `adview_type` varchar(11) NOT NULL DEFAULT '0' COMMENT '广告主行业分类',
  ...
  `request` varchar(64) DEFAULT '0' COMMENT '广告主行业分类',
  `bid` varchar(64) DEFAULT '0' COMMENT '广告主行业分类',
  `imp` varchar(64) DEFAULT '0' COMMENT '广告主行业分类',
  `click` varchar(64) DEFAULT '0' COMMENT '广告主行业分类',
  `download` varchar(64) DEFAULT '0' COMMENT '广告主行业分类',
  `cost` varchar(64) DEFAULT '0' COMMENT '广告主行业分类',
  `revenue` varchar(64) DEFAULT '0' COMMENT '广告主行业分类',
  PRIMARY KEY (`date`,`user_id`,`idea_id`,`adx`)
...
DELIMITER ;;
CREATE  PROCEDURE `realtime_action`(IN `table_create_date` VARCHAR(20) CHARSET utf8)
    DETERMINISTIC
    COMMENT '创建分钟统计表'
BEGIN
...
DELIMITER ;;
CREATE  PROCEDURE `realtime_bidding`(IN `table_create_date` VARCHAR(20) CHARSET utf8)
    DETERMINISTIC
    COMMENT '创建分钟统计表'
BEGIN
	DECLARE table_name VARCHAR(20);
...
DELIMITER ;;
CREATE  PROCEDURE `realtime_bidding_single`(IN `table_create_date` VARCHAR(20) CHARSET utf8)
    DETERMINISTIC
    COMMENT '创建分钟统计表'
BEGIN
	DECLARE table_name VARCHAR(20);
...
DELIMITER ;;
CREATE  PROCEDURE `realtime_click`(IN `table_create_date` VARCHAR(20) CHARSET utf8)
    DETERMINISTIC
    COMMENT '创建分钟统计表'
BEGIN
	DECLARE table_name VARCHAR(20);
...
DELIMITER ;;
CREATE  PROCEDURE `realtime_imp`(IN `table_create_date` VARCHAR(20) CHARSET utf8)
    DETERMINISTIC
    COMMENT '创建分钟统计表'
BEGIN
	DECLARE table_name VARCHAR(20);
