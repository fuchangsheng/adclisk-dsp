...
<div class="header high">
    <h1>Code coverage report for <span class="entity">htmlcs/lib/rules/self-close.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">htmlcs/lib/rules/</a> &#187; self-close.js</div>
</div>
<div class="body">
...
&nbsp;
    format: function (getCfg, document, options) {
        options['self-close'] = getCfg() === 'close' ? <span class="branch-0 cbranch-no" title="branch not covered" >'close' </span>: 'no-close';
    }
};
&nbsp;</pre></td></tr>
</table></pre>
