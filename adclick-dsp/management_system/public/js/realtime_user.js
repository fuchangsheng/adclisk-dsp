...
function selectchange() {
    ...
    l_con = $('#l_con').val();
    r_con = $('#r_con').val();
    initRealTimeChart(myChart, l_con, r_con, arr[0], arr[1], choosed_user_id, type);
}
...
$('#downloadcsv').click(function() {
    ...
    param = {
        sinterface : SERVERCONF.DASHBOARD.REALTIMEUSERDOWNLOAD,
        data : {
            user_id : choosed_user_id,
            start_time : arr[0],
            end_time : arr[1],
