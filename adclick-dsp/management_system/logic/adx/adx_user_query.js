/*
 * @file  adx_user_query.js
 * @description adx user query API and logic
 ...
 */
'use strict';
var MODULENAME = 'adx_user_query.logic';
var URLPATH = '/v1/adx/user/query';
...
function processRequest(param, fn){
    ...
    var msg = ' to process adx user audit query request for :' +  param.id;
    ...
    mAsync.waterfall([
        ...
        function(data, next) {
            ...
            if (!adx) {
                ...
                adx.userAuditQuery(query, function(err, res) {
                    if(err) {
                        next(err);
                    } else {
                        next(null, res);
