 ...
 */
'use strict';
var MODULENAME = 'ad_account_invoice_list.logic';
var URLPATH = '/v3/settings/finance/invoice-info/list';
...
function packageResponseData(data){
    ...
    for (var i = 0; i < invoices.length; i++) {
        var invoice = {
            ...
            audit_status: ADCONSTANTS.AUDIT.format(invoices[i].audit_status),
