/*
 * @file  logic_api.js
 * @description dsp management logic helper model and API
            ...
            if (err) {
                ...
                if (data.auth) {
                    ...
                    req.session.userInfo = {
                        mgr_id: data.auth.mgr_id,
                        role: data.auth.role,
                        mgr_name: data.auth.mgr_name
                    }
                    json.code = 0;
                    json.message = '';
                    ...
                    json.code = 0;
                    json.message = 'Success to logout !';
                    json.data = data || {};
                }
            }
            res.json(json);
