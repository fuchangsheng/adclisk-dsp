/*
 * @file dashboard_realtime.test.js
 * @description test the interfaces of dashboard_realtime model
 ...
 */
'use strict';
var MODULENAME = 'dashboard_realtime.test';
...
//model
var overview_all = require('../model/dashboard_realtime/dashboard_realtime_all.test').create();
var download_all = require('../model/dashboard_realtime/dashboard_realtime_all_download.test').create();
var overview_user = require('../model/dashboard_realtime/dashboard_realtime_user.test').create();
var download_user = require('../model/dashboard_realtime/dashboard_realtime_user_download.test').create();
var overview_adx = require('../model/dashboard_realtime/dashboard_realtime_adx.test').create();
var download_adx = require('../model/dashboard_realtime/dashboard_realtime_adx_download.test').create();
var dashboard_query = require('../model/dashboard_realtime/dashboard_query.test').create();

var msg;

msg = 'to test interfaces of dashboard_realtime module.';
...
describe('dashboard_realtime module', function(){
    var id;
    var param = {
    ...
    it(dashboard_query.description, function(done){
        dashboard_query.test({}, function(data){
            done();
        });
    });
