...
<div class="header high">
    <h1>Code coverage report for <span class="entity">htmlcs/lib/other-formatter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">htmlcs/lib/</a> &#187; other-formatter.js</div>
</div>
<div class="body">
...
&nbsp;
        // javascript content
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!type || type === 'text/javascript') {
