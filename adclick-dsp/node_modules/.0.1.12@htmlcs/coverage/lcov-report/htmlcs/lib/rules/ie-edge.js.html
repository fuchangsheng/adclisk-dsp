...
&nbsp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (title &amp;&amp; title.nextSibling) {
                head.insertBefore(edgeMeta, title.nextSibling);
            }
            else {
<span class="cstat-no" title="statement not covered" >                head.appendChild(edgeMeta);</span>
            }
        }
    }
&nbsp;
