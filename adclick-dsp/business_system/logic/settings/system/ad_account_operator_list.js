 ...
 */
'use strict';
var MODULENAME = 'ad_account_operator_list.logic';
var URLPATH = '/v3/settings/system/operator/list';
...
function processRequest(param, fn){
    ...
    mAsync.waterfall([
        ...
        function(next) {
            ...
            if (mUtils.isExist(param.role_id)) {
                match.role = param.role_id;
            }
