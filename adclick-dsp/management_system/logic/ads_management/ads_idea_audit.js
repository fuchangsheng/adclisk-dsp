/*
 * @file  ads_idea_audit.js
 * @description ad idea audit view API and logic
 ...
 */
'use strict';
var MODULENAME = 'ads_idea_audit.logic';
var URLPATH = '/v1/aduser/ads/idea/audit';
...
function processRequest(param, fn){
    ...
    mAdClickIdeaAuditModel.update(query, function(err, rows){
        if (err) {
